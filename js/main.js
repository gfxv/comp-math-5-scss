...
window.onload = () => {
  ...
  const newtonEndResult = document.getElementById("newton-en d-result").getBoundingClientRect().width;
  ...
  document.getElementById("newton-end-result-placeholder").innerText = "Newton end: " + newtonEndResult;
